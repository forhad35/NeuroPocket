...
class OnDeviceLlmService implements IOnDeviceLlmService {
  ...
  static const List<LocalModelInfo> defaultModelCatalog = [
    LocalModelInfo(
      ...
      size: '398 MB',
      description: 'বাংলা, বাংলিশ ও ইংরেজির জন্য সেরা লাইটওয়েট দ্রুতগতির অন-ডিভাইস মডেল (Recommended)।',
      downloadUrl:
    ...
    LocalModelInfo(
      ...
      size: '986 MB',
      description: 'বাংলা ও বাংলিশে উচ্চমানের বুদ্ধিমত্তা ও নিখুঁত অনুবাদের জন্য শক্তিশালী মডেল।',
      downloadUrl:
    ...
    LocalModelInfo(
      ...
      size: '229 MB',
      description: 'উচ্চমানের ইংরেজি ল্যাঙ্গুয়েজ ও দ্রুত গ্রামার ফিক্সের জন্য বিশেষভাবে প্রস্তুতকৃত লাইট মডেল।',
      downloadUrl:
    ...
    LocalModelInfo(
      ...
      size: '808 MB',
      description: 'অফলাইনে উন্নত ইংরেজি রচনা, গ্রামার ও অল্টারনেটিভ বাক্যের জন্য মেটার ১ বিলিয়ন মডেল।',
      downloadUrl:
